...
class UtilisateurServiceIntegrationTestSpec extends Specification {
    ...
    void "test addToFavorite"() {
        List<Musee> museeList = new ArrayList<>()
        given: "Un utilisateur et musee "
        Adresse uneAdresse = new Adresse(numero: 2, rue: "RUE DES ARCHIVES", codePostal: 31500, ville: "TOULOUSE").save()
        Gestionnaire unGestionnaire = new Gestionnaire(nom: "gestionnaire").save()
        Musee uneMusee =
                new Musee(nom: "ARCHIVES MUNICIPALES TOULOUSE",
                        horairesOuverture: "Ouvert du lundi au vendredi de 9h à 17h. Fermeture de 12h à 13h30 pendant toutes les vacances scolaires. Fermeture annuelle la dernière quinzaine de juillet.",
                        telephone: "05 61 61 63 33",
                        accesMetro: "Roseraie (A)", accesBus: "36, 38", gestionnaire: unGestionnaire,
                        adresse: uneAdresse).save()
    ...
    void "test addDemandeVisite"() {
        ...
        Adresse uneAdresse = new Adresse(numero: 2, rue: "RUE DES ARCHIVES", codePostal: 31500, ville: "TOULOUSE").save()
        Adresse uneAdresse1 = new Adresse(numero: 5, rue: "RUE SAINT PANTALEON", codePostal: 31000, ville: "TOULOUSE").save()
        Gestionnaire unGestionnaire = new Gestionnaire(nom: "gestionnaire").save()
        Musee uneMusee =
                new Musee(nom: "ARCHIVES MUNICIPALES TOULOUSE",
                        horairesOuverture: "Ouvert du lundi au vendredi de 9h à 17h. Fermeture de 12h à 13h30 pendant toutes les vacances scolaires. Fermeture annuelle la dernière quinzaine de juillet.",
        ...
        Musee uneMusee1 =
                new Musee(nom: "CMAV - CENTRE MERIDIONAL DE L'ARCHITECTURE DE LA VILLE",
                        ...
                        accesMetro: "Capitole (A), Jean Jaurès (B)", accesBus: "ncv, 2, 10, 12, 14, 38, 78 et 80", gestionnaire: unGestionnaire,
                        adresse: uneAdresse1)
