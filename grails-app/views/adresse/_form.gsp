<%@ page import="projetjee2015.Adresse" %>
...
<div class="fieldcontain ${hasErrors(bean: adresseInstance, field: 'numero', 'error')} required">
	...
	<g:field name="numero" type="number" min="0" value="${adresseInstance.numero}" required=""/>
...
<div class="fieldcontain ${hasErrors(bean: adresseInstance, field: 'codePostal', 'error')} required">
	...
	<g:field name="codePostal" type="number" min="0" value="${adresseInstance.codePostal}" required=""/>
