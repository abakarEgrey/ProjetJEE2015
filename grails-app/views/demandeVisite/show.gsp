	...
	<body>
		...
		<div id="show-demandeVisite" class="content scaffold-show" role="main">
			...
			<ol class="property-list demandeVisite">
				...
				<g:if test="${demandeVisiteInstance?.status}">
				<li class="fieldcontain">
					<span id="status-label" class="property-label"><g:message code="demandeVisite.status.label" default="Status" /></span>
					
						<span class="property-value" aria-labelledby="status-label"><g:fieldValue bean="${demandeVisiteInstance}" field="status"/></span>
