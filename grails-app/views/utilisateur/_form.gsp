<%@ page import="projetjee2015.Utilisateur" %>
...
<div class="fieldcontain ${hasErrors(bean: utilisateurInstance, field: 'demandeDeVisites', 'error')} ">
	<label for="demandeDeVisites">
		<g:message code="utilisateur.demandeDeVisites.label" default="Demande De Visites" />
		
	</label>
	<g:select name="demandeDeVisites" from="${projetjee2015.DemandeVisite.list()}" multiple="multiple" optionKey="id" size="5" value="${utilisateurInstance?.demandeDeVisites*.id}" class="many-to-many"/>

</div>

<div class="fieldcontain ${hasErrors(bean: utilisateurInstance, field: 'musees', 'error')} ">
	<label for="musees">
		<g:message code="utilisateur.musees.label" default="Musees" />
		
	</label>
	<g:select name="musees" from="${projetjee2015.Musee.list()}" multiple="multiple" optionKey="id" size="5" value="${utilisateurInstance?.musees*.id}" class="many-to-many"/>
