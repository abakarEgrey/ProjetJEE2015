	...
	<body>
		...
		<div id="show-utilisateur" class="content scaffold-show" role="main">
			...
			<ol class="property-list utilisateur">
				...
				<g:if test="${utilisateurInstance?.demandeDeVisites}">
				<li class="fieldcontain">
					<span id="demandeDeVisites-label" class="property-label"><g:message code="utilisateur.demandeDeVisites.label" default="Demande De Visites" /></span>
					
						<g:each in="${utilisateurInstance.demandeDeVisites}" var="d">
						<span class="property-value" aria-labelledby="demandeDeVisites-label"><g:link controller="demandeVisite" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></span>
						</g:each>
					
				</li>
				</g:if>
			
				<g:if test="${utilisateurInstance?.musees}">
				<li class="fieldcontain">
					<span id="musees-label" class="property-label"><g:message code="utilisateur.musees.label" default="Musees" /></span>
					
						<g:each in="${utilisateurInstance.musees}" var="m">
